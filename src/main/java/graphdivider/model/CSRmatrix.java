...
{
    // Returns the value at the specified row and column, or 0 if not present
    public int getValue(int row, int col)
    {
        // Search for the column in the current row
    ...
    // Prints the CSR matrix data and, for small matrices, the full dense matrix
